...
var LoadingGrid$1 = function LoadingGrid() {
...
var Grid = function (_React$Component) {
    ...
    createClass(Grid, [{
        ...
        value: function render() {
            ...
            }) : React.createElement(LoadingGrid$1, null);
...
var Grid$2 = function (_React$Component) {
    inherits(Grid, _React$Component);
    ...
    createClass(Grid, [{
        ...
        value: function render() {
            ...
            var content = this.state.aphorisms.length ? this.state.aphorisms.map(function (aphorism) {
                return React.createElement(Row$1, { key: aphorism._id, aphorism: aphorism, onDestroy: _this4.onDestroy.bind(_this4) });
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                !this.state.plusAphorism ? "Add" : "del"
                            )
                        )
                    )
                ),
                this.state.showMore ? React.createElement(Grid, null) : null,
                this.state.plusAphorism ? React.createElement(Grid$2, null) : null
            );
        }
    }]);
    return Container;
